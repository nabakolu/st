...
static char *font = "ComicMono Nerd Font:pixelsize=16:antialias=true:autohint=true";
...
static char *openurlcmd[] = { "/bin/sh", "-c",
			      "sed 's/.*│//g' | tr -d '\n' | grep -aEo '(((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./&%?$#=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)'| uniq | sed 's/^www./http:\\/\\/www\\./g' | dmenu -i -p 'Follow which url?' -l 10 | xargs -r urlopener.sh",
			      "externalpipe", NULL };
...
static Shortcut shortcuts[] = {
	...
	{ TERMMOD,              XK_asterisk,       zoom,           {.f = +1} }, // actually ctrl+shif+plus
	{ TERMMOD,              XK_underscore,        zoom,           {.f = -1} }, // actually ctrl+shif+minus
	{ TERMMOD,              XK_apostrophe,        zoomreset,      {.f =  0} }, // actually ctrl+shif+hash
